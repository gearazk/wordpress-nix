!function(a) {
    ...
    var b = new Clipboard(".affpromos-clipboard");
    b.on("success", function(a) {
        a.clearSelection();
    });
}), jQuery(document).on("click", ".affpromos-clipboard", function(a) {
    var b = jQuery(this), c = jQuery(this).html(), d = jQuery(this).data("affpromos-clipboard-confirmation-text");
